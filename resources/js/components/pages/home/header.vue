				...
				<ul class="navbar-nav navbar-nav-scroll ms-auto">
                    ...
                    <li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle active"
                            href="#" id="demoMenu" data-bs-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">Cours</a>
                         <ul class="dropdown-menu" aria-labelledby="demoMenu" >
                            <li v-for="subject in subjects" :key="subject.id">
                                <a class="dropdown-item">{{ subject.name }}
                                    <ul>
                                    <li v-for="learning in subject.learnings" :key="learning.id">
                                        <router-link :to="{name: 'Detailducours', params: {name: learning.name}}"
                                        class="dropdown-item">{{ learning.name }}</router-link>
                                    </li>
							</ul>
                            </a>
                        </li>
			...
			<ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
				...
				<li class="nav-item ms-3 dropdown">
					...
					<ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
						...
						<li><button class="dropdown-item bg-danger-soft-hover" @click="logout()"><i class="bi bi-power fa-fw me-2"></i>Sign Out</button></li>
						<li> <hr class="dropdown-divider"></li>
