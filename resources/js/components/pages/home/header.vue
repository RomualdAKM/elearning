...
const getSubjects = async () => {
    let response = await axios.get(`/api/get_subjects/${level_id.value}`);
                            ...
                            >
                                ...
                                >
                                    <a class="dropdown-item"
                                        ...
                                        <ul>
                                            <li
                                                v-for="learning in subject.learnings"
                                                :key="learning.id"
                                            >
                                                <router-link
                                                    :to="{
                        ...
                        >
                            ...
                            <li >
                                <button
                                    ...
                                    @click="logout()"
                                >
                                    <i class="bi bi-power fa-fw me-2"></i>Sign
                                    Out
                                </button>
                            </li>
