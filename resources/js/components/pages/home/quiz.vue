    ...
    <div class="container">
        ...
        <div v-if="!quizCompleted">
            <div v-if="quizzes.length > 0">
                ...
                >
                    <h4 class="mt-5">Question : {{ quiz.question }}</h4>
                    <hr />
                    <div class="vstack gap-2">
                        <div>
                            <input
                                ...
                                @change="selectResponse(quiz.option1)"
                            />
                            <label
                        ...
                        <div>
                            <input
                                ...
                                :value="quiz.option2"
                                v-model="userResponses[currentQuestionIndex]"
                                @change="selectResponse(quiz.option2)"
                            />
                            <label
                                class="btn btn-outline-primary w-100"
                                :for="'option2-' + quiz.id"
                        ...
                        <div>
                            <input
                                ...
                                :value="quiz.option3"
                                v-model="userResponses[currentQuestionIndex]"
                                @change="selectResponse(quiz.option3)"
                            />
                            <label
                                class="btn btn-outline-primary w-100"
                                :for="'option3-' + quiz.id"
        ...
        <div v-if="quizCompleted">
            ...
            <h5 class="mt-4 mb-5">
                Votre score est : {{ score }}/{{ quizzes.length }}
            </h5>
        </div>
    </div>
    <my-footer></my-footer>
