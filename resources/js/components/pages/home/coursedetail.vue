...
const getLearning = async () => {
    await axios
        .get(`/api/get_learning/${name.value}`)
        .then((response) => {
                    ...
                    <div class="row g-lg-5">
                        ...
                        <div class="col-12 mt-6">
                            <div class="video-player rounded-3">
                                ...
                                >
                                    <source
                                        :src="learnings.chapters?.[key]?.url"
                                        type="video/mp4"
                                        size="360"
                                    />
                                     Caption files
                                ...
                                <div class="col-12">
                                    ...
                                    >
                                        ...
                                        <div class="d-flex mt-2 mt-sm-0">
                                            <a
                                                class="btn btn-danger-soft btn-sm mb-0"
                                                :href="
                                                    learnings.chapters?.[key]
                                                        ?.file
                                                "
                                                >Download PDF</a
                                            >
                                    ...
                                    <div class="col-12">
                                        ...
                                        >
                                            ...
                                            <div class="accordion-item mb-3">
                                                ...
                                                >
                                                    <div
                                                        class="accordion-body mt-3"
                                                    >
                                                        <h2>Chapitres :</h2>
                                                        <div
                                                            class="vstack gap-3 p-2"
                                                            v-for="(
                                                                chapter, index
                                                            ) in learnings.chapters"
                                                            :key="chapter.id"
                                                        >
                                                            <!-- Course lecture -->
                                                            <div
