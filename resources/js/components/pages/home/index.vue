	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xl-6 text-center">
				<!-- Badge title -->
				<h6 class="mb-3 font-base bg-blue text-white py-2 px-4 rounded-2 d-inline-block"><i class="fas fa-school me-2"></i>St Joseph, Eugene, Oregon, USA</h6>
				<!-- Title -->
				<h1>The Best kindergarten You Can Get</h1>
				<p class="mb-5">The best cost-efficient choice for parents looking for high-quality education, Dedicated Timetabled Lessons Offered with qualified Staff.</p>
						...
						<div class="d-flex justify-content-center align-items-center">
							...
							<div class="ms-3">
								<div class="d-flex text-dark">
									<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="1"	data-purecounter-delay="500">0</h5>
					...
					<div class="col-sm-6 col-md-4 col-xl-6 col-xxl-4">
						<div class="d-flex justify-content-center align-items-center">
							...
							<div class="ms-3 text-start">
								<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="105"	data-purecounter-delay="300">0</h5>
				...
				<div class="d-sm-flex justify-content-center align-items-center mt-5">
					<!-- Button -->
					<div> <a href="#" class="btn btn-lg btn-primary-soft mb-3 mb-sm-0">Book now</a> </div>
					<!-- Rating -->
							...
							<div class="row g-3 d-flex align-items-center justify-content-center">
								...
								<div class="col-sm-6 col-lg-3 text-center">
									<div class="d-flex justify-content-center">
										<h4 class="purecounter display-6 text-white fw-bold mb-0" data-purecounter-start="0" data-purecounter-end="89"	data-purecounter-delay="200">0</h4>
									</div>
									<h6 class="text-dark mb-0 fw-bold">Total Instructors</h6>
								</div>

								<!-- Counter item -->
								<div class="col-sm-6 col-lg-3 text-center">
									<div class="d-flex justify-content-center">
										<h4 class="purecounter display-6 text-white fw-bold mb-0" data-purecounter-start="0" data-purecounter-end="12"	data-purecounter-delay="200">0</h4>
									</div>
									<h6 class="text-dark mb-0 fw-bold">Total Campuses</h6>
								</div>

								<!-- Counter item -->
								<div class="col-sm-6 col-lg-3 text-center">
									<div class="d-flex justify-content-center">
										<h4 class="purecounter display-6 text-white fw-bold mb-0" data-purecounter-start="0" data-purecounter-end="180"	data-purecounter-delay="200">0</h4>
										<span class="display-6 text-white mb-0">K</span>
									</div>
									<h6 class="text-dark mb-0 fw-bold">Students till date</h6>
								</div>

								<!-- Counter item -->
								<div class="col-sm-6 col-lg-3 text-center">
									<div class="d-flex justify-content-center">
										<h4 class="purecounter display-6 text-white fw-bold mb-0" data-purecounter-start="0" data-purecounter-end="23"	data-purecounter-delay="200">0</h4>
										<span class="display-6 text-white mb-0">+</span>
									</div>
									<h6 class="text-dark mb-0 fw-bold">Types of Courses</h6>
								</div>
							</div>
						</div>
					</div> <!-- Row END -->
				...
				<div class="row mt-5">
					...
					<div class="col-sm-6 col-lg-12 col-xl-6 mb-5">
						<div class="card card-body shadow">
							...
							<h6>Email</h6>
							<p class="h6 mb-0"><a href="#" class="text-primary-hover fw-light stretched-link">example@gmail.com</a></p>
						</div>
					</div>
					...
					<div class="col-sm-6 col-lg-12 col-xl-6 mb-5 mb-xl-0">
						<div class="card card-body shadow">
							...
							<h6>Website</h6>
							<p class="h6 mb-0"><a href="#" class="text-primary-hover fw-light stretched-link">http://example.com</a></p>
						</div>
					</div>
				</div>
			</div>
